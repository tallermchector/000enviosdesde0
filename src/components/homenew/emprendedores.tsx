...
const SOLUTIONS = [
  {
    ...
    icon: Building2,
    colorClass: "from-[#001de0] to-[#3b53ff] text-[#001de0]",
    borderColor: "hover:border-[#001de0]/40",
    glowColor: "hover:shadow-[#001de0]/5",
    topGradient: "from-[#001de0] to-[#3b53ff]",
    items: [
  ...
  },
  {
    ...
    icon: ShoppingBag,
    colorClass: "from-[#e9c400] to-[#ffd700] text-[#e9c400]",
    borderColor: "hover:border-[#e9c400]/40",
    glowColor: "hover:shadow-[#e9c400]/5",
    topGradient: "from-[#e9c400] to-[#ffd700]",
    items: [
