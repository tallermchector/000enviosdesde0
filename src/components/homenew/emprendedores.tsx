          ...
          {SOLUTIONS.map((sol, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative flex flex-col p-8 rounded-none border-2 border-black bg-white shadow-[4px_4px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#000] transition-all duration-150 overflow-hidden"
              >
                {/* Top solid accent line */}
                <div className={`absolute top-0 left-0 right-0 h-1.5 ${sol.topBg}`} />
