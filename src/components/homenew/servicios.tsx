    ...
    <section className="relative py-24 overflow-hidden bg-white text-[#000833] transition-colors duration-300 border-t-2 border-black">
      ...
      <div className="relative z-10 mx-auto max-w-[1280px] px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col justify-between h-full flex-1">
                <div>
                  ...
                  <p className="text-body-sm text-[#444556] leading-relaxed mb-6">
                  ...
                  {/* Technical details receipt layout */}
                  <div className="border-t border-b border-dashed border-black/30 py-3 mb-6 font-mono text-[10px] uppercase font-bold tracking-wider space-y-1.5 text-black/70">
                    <div className="flex justify-between">
                      <span>TIPO DE ENVÍO:</span>
                      <span className="text-black">EXPRESS // DIRECTO</span>
                    </div>
                    <div className="flex justify-between">
                      <span>RANGO DE ENTREGA:</span>
                      <span className="text-black">&lt; 2 HORAS</span>
                    </div>
                    <div className="flex justify-between">
                      <span>COBERTURA:</span>
                      <span className="text-black">URBANA MDP</span>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  asChild
                  className="w-full bg-[#000833] hover:bg-[#00041a] text-white font-sans font-bold uppercase rounded-none border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[4px_4px_0px_#000] flex items-center justify-center gap-2 transition-all duration-150"
                >
            ...
            >
              ...
              <div className="relative z-10 flex flex-col justify-between h-full flex-1">
                <div>
                  ...
                  <p className="text-body-sm text-[#444556] leading-relaxed mb-6">
                    Variabilizá tus costos logísticos. Ingresá tus pedidos antes de las 13:00 hs y garantizamos entrega en el mismo día.
                  </p>
                  ...
                  <div className="border-t border-b border-dashed border-black/30 py-3 mb-6 font-mono text-[10px] uppercase font-bold tracking-wider space-y-1.5 text-black/70">
                    <div className="flex justify-between">
                      <span>TIPO DE ENVÍO:</span>
                      <span className="text-black">RUTEADO // FLEX</span>
                    </div>
                    <div className="flex justify-between">
                      <span>RANGO DE ENTREGA:</span>
                      <span className="text-black">MISMO DÍA (CORTE 13:00)</span>
                    </div>
                    <div className="flex justify-between">
                      <span>COBERTURA:</span>
                      <span className="text-black">INTERURBANA MDP</span>
                    </div>
                  </div>
                </div>
                ...
                <Button
                  asChild
                  className="w-full bg-[#e9c400] hover:bg-white hover:text-[#000833] text-black font-sans font-bold uppercase rounded-none border-2 border-black shadow-[2px_2px_0px_#000] hover:shadow-[4px_4px_0px_#000] flex items-center justify-center gap-2 transition-all duration-150"
                >
          ...
          {/* Card 3: Integraciones PyMEs & 3PL */}
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          ...
          >
            ...
            >
              {/* Top accent line */}
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-[#13bb2e] z-10" />

              <div className="relative z-10 flex flex-col justify-between h-full flex-1">
                <div>
                  <div className="flex items-center justify-between mb-6">
                    <div className="p-3 rounded-none bg-[#13bb2e]/10 border-2 border-black text-[#13bb2e] group-hover:scale-105 transition-transform duration-150">
                      <Boxes className="w-6 h-6" />
                    </div>
                    <span className="px-3 py-1 rounded-none border-2 border-black bg-[#000833] text-[#E9C400] text-[10px] font-bold font-mono uppercase tracking-wider">
                      FULFILLMENT
                    </span>
                  </div>
                  ...
                  <p className="text-xs font-bold text-black font-mono mb-4 uppercase tracking-wider">
                    Almacenamiento y logística integral.
                  </p>
                  
                  <p className="text-body-sm text-[#444556] leading-relaxed mb-6">
                    Delegá tu stock en nuestro centro de distribución de última milla. Nosotros preparamos, etiquetamos y despachamos.
                  </p>
                  ...
                  <div className="border-t border-b border-dashed border-black/30 py-3 mb-6 font-mono text-[10px] uppercase font-bold tracking-wider space-y-1.5 text-black/70">
                    <div className="flex justify-between">
                      <span>TIPO DE ENVÍO:</span>
                      <span className="text-black">ALMACENAJE + 3PL</span>
                    </div>
                    <div className="flex justify-between">
                      <span>RANGO DE ENTREGA:</span>
                      <span className="text-black">DESPACHO CONTINUO 24H</span>
                    </div>
                    <div className="flex justify-between">
                      <span>COBERTURA:</span>
                      <span className="text-black">MDP + COSTA ATLÁNTICA</span>
                    </div>
                  </div>
                </div>
