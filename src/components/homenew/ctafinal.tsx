  ...
  return (
    <section className="relative py-28 overflow-hidden bg-background text-foreground transition-colors duration-300 border-t border-border/10">
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-primary/10 rounded-full blur-[140px] dark:bg-primary/15" />
      </div>
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-6 md:px-[60px]">
        <motion.div
          ...
          className="relative max-w-4xl mx-auto p-12 md:p-16 rounded-3xl border border-primary/20 bg-card/30 backdrop-blur-sm overflow-hidden text-center flex flex-col items-center"
        >
          {/* Border glowing accent */}
          <div className="absolute top-0 left-0 right-0 h-1 bg-gradient-to-r from-primary via-[#0084ff] to-primary/30" />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 w-full sm:w-auto">
            <Button
              asChild
              size="lg"
              className="w-full sm:w-auto h-12 rounded-full pl-6 pr-5 text-base font-semibold font-roboto bg-primary text-primary-foreground hover:bg-primary/90 hover:scale-[1.02] transition-all duration-200 shadow-md shadow-primary/20"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="w-full sm:w-auto h-12 rounded-full px-6 text-base font-semibold font-roboto border-border hover:bg-accent/40 transition-colors duration-200"
            >
