      ...
      <div className="relative z-10 mx-auto grid w-full max-w-[1280px] grid-cols-1 items-center gap-16 px-6 md:grid-cols-2">
        <ContainerStagger className="flex flex-col items-start max-w-xl">
          ...
          <ContainerAnimated className="w-full grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
            <div className="flex gap-3 items-start p-4 border-2 border-black bg-white shadow-[3px_3px_0px_#000] hover:translate-x-[-1px] hover:translate-y-[-1px] hover:shadow-[4px_4px_0px_#000] transition-all duration-150">
          ...
          <ContainerAnimated className="w-full border-t-2 border-dotted border-black pt-8 flex flex-col sm:flex-row gap-4">
            <div className="flex-1 p-4 border-2 border-black bg-white shadow-[4px_4px_0px_#000] hover:translate-x-[-2px] hover:translate-y-[-2px] hover:shadow-[6px_6px_0px_#000] transition-all duration-150 group">
